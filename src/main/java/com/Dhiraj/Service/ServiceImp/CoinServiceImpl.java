...
import com.Dhiraj.Repository.CoinRepository;
...
public class CoinServiceImpl implements CoinService {
    ...
    public List<Coin> getCoinList(int page) throws Exception {
        ...
        try {
            ...
            throw new Exception(" Please Try After Sometime SomeThing went wrong.... "+e.getMessage());
        }
    }
    ...
    public String getMarketChart(String coinId, int days) throws Exception {
        ...
        try {
            ...
            throw new Exception("Something went Wrong try After sometime... "+ e.getMessage());
        }
    }
    ...
    public Coin findById(String coinId) throws Exception {
        return coinRepository.findById(coinId).orElseThrow(()->new Exception("Invalid coin id"));
    }
